...
Vue.component('jas-more-searcher', {
  ...
  template: [
    ...
    '  <div class="bgfff " style="display: flex;flex-direction: row;align-items: center;height: 44px;">',

    '    <div',
    '      style="flex: 1;display: flex;align-items: center;height: 36px;margin: 0 10px;padding:0 10px;background: #eeeeee;border-radius: 8px;">',
    ...
    '        </form>',
    '      </div>',
    '      <div class="mint-field-clear" v-show="isfocus" @click="clear"><i class="mintui mintui-field-error"></i></div>',
    '      <div v-if="isbtn" class="pl10 " style="line-height: 44px;">',
    '           <span class="fs18" style="vertical-align:middle; border-left:1px solid #c3c0c0;"></span>',
    '          <button @click="searchList" style="width:38px;height: 100%;" class="theme_color1_clr pl8">搜索</button>',
    '      </div>',
    '    </div>',

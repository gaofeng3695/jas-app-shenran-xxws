...
Vue.component('jas-select-field', {
  ...
  template: [
    ...
    '      {{label}}',
    '      <div v-if="(!isSearch && isMulti) || isShowClear" style="float:right;font-size:12px;padding-right:10px;color:#26a2ff;" @click="clearValue">清空</div>   ',
    '    </div>',
    '    <div style="width:100vw;max-height: 60vh;overflow: auto;">',
